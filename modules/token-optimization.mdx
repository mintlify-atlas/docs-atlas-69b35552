---
title: "Token Optimization: Shell Compression and File Caching"
sidebarTitle: "Token Optimization"
description: "KiroGraph reduces token usage via shell output compression (60–90% savings), prose compression, and cached file reads that skip unchanged files entirely."
---
...
| `enableAgentUtils` | boolean | `false` | Enable `kirograph_read`, `kirograph_retrieve`, `kirograph_gain`, and `kirograph_budget` |
