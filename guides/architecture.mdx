...
description: "KiroGraph-Arch detects architectural layers, computes package coupling metrics (Ca, Ce, instability), and lets you diff graph snapshots before and after refactors."
---
