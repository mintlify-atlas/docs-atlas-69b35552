...
description: "KiroGraph-Sec goes beyond CVE reporting — it uses your call graph to check whether vulnerable dependency code is actually reachable from your application's entry points."
---
