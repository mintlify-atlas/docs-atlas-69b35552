---
title: "Configure KiroGraph with .kirograph/config.json"
...
<ParamField body="extractDocstrings" type="boolean" default="true">
  Extract JSDoc comments, Python docstrings, and inline documentation comments for each symbol.
</ParamField>

<ParamField body="trackCallSites" type="boolean" default="true">
...
<ParamField body="memoryKeepRaw" type="boolean" default="true">
...
<ParamField body="memorySessionTimeout" type="number" default="3600000">
  Session timeout in milliseconds (default: 1 hour). Observations after this window start a new session.
</ParamField>
...
<ParamField body="docsContextThreshold" type="number" default="0.5">
...
<ParamField body="shellCompressionLevel" type="string" default="normal">
...
<ParamField body="enableAgentUtils" type="boolean" default="false">
