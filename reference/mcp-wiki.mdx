---
title: "Wiki Module MCP Tools Reference"
sidebarTitle: "Wiki Tools"
description: "Reference for KiroGraph's wiki MCP tools implementing the Karpathy LLM wiki pattern: ingest, apply, lint, search, and manage knowledge pages across sessions."
---
