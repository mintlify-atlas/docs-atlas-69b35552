...
description: "KiroGraph CLI setup: install configures MCP integration, init creates the index, hook manages the global library, uninit removes integration files."
---
