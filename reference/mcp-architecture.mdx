---
title: "Architecture MCP Tools Reference"
sidebarTitle: "Architecture Tools"
description: "Reference for KiroGraph's 5 architecture MCP tools: package graph, layer detection, coupling metrics, instability scores, and dependency depth analysis."
---
