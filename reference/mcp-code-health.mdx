---
title: "Code Health MCP Tools Reference"
...
Detect clusters of tightly related symbols using a graph community-detection algorithm. Returns community IDs, member counts, and the symbols in each community — useful for identifying emergent module boundaries.

<ParamField body="resolution" type="number">
  Granularity from 0.1 to 2.0. Higher values produce more, smaller communities.
</ParamField>

<ParamField body="limit" type="number">
  Maximum communities to return (default 15).
</ParamField>
