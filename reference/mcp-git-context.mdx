---
title: "Git Context MCP Tools Reference"
sidebarTitle: "Git Context"
description: "Reference for KiroGraph's git context MCP tools: diff context, commit context, PR context, test mapping, affected tests, hotspots, and staleness analysis."
---
